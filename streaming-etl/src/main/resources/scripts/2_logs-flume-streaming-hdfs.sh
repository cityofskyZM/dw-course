...
放置在master上的/home/hadoop-twq/dw-course/streaming-etl/apache-flume-1.8.0-bin/lib下

## 2、启动flume的agent
apache-flume-1.8.0-bin/bin/flume-ng agent --conf conf --conf-file flume/taildir_spark_streaming-flume-conf.properties --name agent1

## 3、启动Spark Streaming应用
 spark-submit --class com.twq.UserActionStreamingEtl \
 ...
 --executor-cores 2 \
 /home/hadoop-twq/dw-course/streaming-etl/streaming-etl-1.0-SNAPSHOT-jar-with-dependencies.jar \
 master 44446
...
STORED AS PARQUET
LOCATION 'hdfs://master:9999/user/hadoop-twq/dw-course/streaming-etl/user-action-parquet/';"
